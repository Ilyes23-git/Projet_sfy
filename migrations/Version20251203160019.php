 ...
 */
final class Version20251203160019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, reference VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, prix_promo DOUBLE PRECISION NOT NULL, stock INT NOT NULL, est_disponible TINYINT NOT NULL, date_creation DATE NOT NULL, commande_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, INDEX IDX_29A5EC2782EA2E54 (commande_id), INDEX IDX_29A5EC27BCF5E72D (categorie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
